// Fig. 17.12: FileDemonstration.java
...
public class FileDemonstration extends JFrame
{
   ...
   private File getFileOrDirectory()
   {
      ...
      //Changes the title of the Dialog Bar
      fileChooser.setDialogTitle("Specify a file or folder to Open");
      //Sets file type filter to only display .txt files
      FileNameExtensionFilter filter = new FileNameExtensionFilter( "Text Documents (*.txt)", "txt" );
      fileChooser.setFileFilter( filter );
      //Disables the view all files filter option
